...
class ComplementaryOrMaskCrossoverService(CrossoverServiceBase):
    ...
    def __create_child(self, parent1, parent2):
        ...
        child_chromosome = [chromosome1[i] if self.__mask[i] == 'X' else chromosome2[i] for i in range(len(chromosome1))]
